...
class ServiceRequest(BaseModel):
    ...
    logprobs: bool = Field(
        default=True, description="Whether to include log probabilities"
    )
    top_logprobs: int = Field(
        default=5, ge=1, description="Number of top log probabilities"
    )
...
class ServiceResponse(BaseModel):
    ...
    references: References = Field(
        ..., description="Reference documents and search results"
    )
