...
export const mockDatasets: Dataset[] = [
  {
    ...
    description: 'Comprehensive database of South African wildlife including species records, habitat information, and conservation status across all major ecosystems.',
  ...
  },
  {
    ...
    description: 'Collection of legal documents, case studies, and regulatory frameworks from various jurisdictions worldwide.',
  ...
  },
  {
    ...
    description: 'Curated collection of peer-reviewed medical research papers and clinical trial data for healthcare AI applications.',
  ...
  },
  {
    ...
    description: 'Annual and quarterly financial reports from publicly traded companies across multiple sectors and geographic regions.',
