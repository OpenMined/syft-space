...
const rootNodes = ref<FileNode[]>([
    ...
    children: [
      {
        ...
        children: [
          {
            name: 'quantum_computing_survey.pdf',
            path: '~/Documents/Research/quantum_computing_survey.pdf',
            type: 'file',
            size: 3145728,
          },
          {
            name: 'ml_algorithms_comparison.pdf',
            path: '~/Documents/Research/ml_algorithms_comparison.pdf',
            type: 'file',
            size: 2621440,
          },
          {
            name: 'thesis_draft.tex',
            path: '~/Documents/Research/thesis_draft.tex',
            type: 'file',
            size: 524288,
          },
          {
            name: 'thesis_draft.pdf',
            path: '~/Documents/Research/thesis_draft.pdf',
            type: 'file',
            size: 1572864,
          },
          {
            name: 'references.bib',
            path: '~/Documents/Research/references.bib',
            type: 'file',
            size: 131072,
          },
        ...
        children: [
          {
            ...
            path: '~/Documents/Work/quarterly_report_2024.docx',
            type: 'file',
            size: 524288,
          },
          {
            name: 'project_proposal.docx',
            path: '~/Documents/Work/project_proposal.docx',
            type: 'file',
            size: 786432,
          },
          {
          ...
          },
          {
            ...
            path: '~/Documents/Work/budget_analysis.xlsx',
            type: 'file',
            size: 1048576,
          },
          {
      ...
      },
      {
        ...
        children: [
          ...
          {
            name: 'cover_letter.odt',
            path: '~/Documents/Personal/cover_letter.odt',
            type: 'file',
            size: 131072,
          },
          {
            name: 'travel_itinerary.rtf',
            path: '~/Documents/Personal/travel_itinerary.rtf',
            type: 'file',
            size: 98304,
          },
        ],
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: 'vscode-linux.deb',
        path: '~/Downloads/vscode-linux.deb',
        type: 'file',
        size: 89128960,
      },
      {
        name: 'research_paper.pdf',
        path: '~/Downloads/research_paper.pdf',
        type: 'file',
        size: 2097152,
      },
    ...
    children: [
      {
        ...
        children: [
          {
            name: 'train_model.py',
            path: '~/Projects/machine-learning/train_model.py',
            type: 'file',
            size: 16384,
          },
          {
            name: 'data_preprocessing.py',
            path: '~/Projects/machine-learning/data_preprocessing.py',
            type: 'file',
            size: 12288,
          },
          {
            name: 'requirements.txt',
            path: '~/Projects/machine-learning/requirements.txt',
            type: 'file',
            size: 2048,
          },
          {
            name: 'README.md',
            path: '~/Projects/machine-learning/README.md',
            type: 'file',
            size: 8192,
          },
          {
            name: 'config.json',
            path: '~/Projects/machine-learning/config.json',
            type: 'file',
            size: 1024,
          },
          {
            name: 'model_weights.h5',
            path: '~/Projects/machine-learning/model_weights.h5',
            type: 'file',
            size: 134217728,
          },
        ],
    ...
    children: [
      {
        ...
        children: [
          {
            name: 'sales_2024.csv',
            path: '~/Data/datasets/sales_2024.csv',
            type: 'file',
            size: 10485760,
          },
          {
            name: 'customer_data.csv',
            path: '~/Data/datasets/customer_data.csv',
            type: 'file',
            size: 5242880,
          },
          {
            name: 'inventory.json',
            path: '~/Data/datasets/inventory.json',
            type: 'file',
            size: 2097152,
          },
          {
            name: 'analytics_export.xlsx',
            path: '~/Data/datasets/analytics_export.xlsx',
            type: 'file',
            size: 8388608,
          },
        ],
      },
      {
        ...
        children: [
          {
            name: 'backup_2024_01.tar.gz',
            path: '~/Data/backups/backup_2024_01.tar.gz',
            type: 'file',
            size: 1073741824,
          },
          {
            name: 'database_dump.sql',
            path: '~/Data/backups/database_dump.sql',
            type: 'file',
            size: 268435456,
          },
          {
            name: 'config_backup.zip',
            path: '~/Data/backups/config_backup.zip',
            type: 'file',
            size: 16777216,
          },
        ],
    ...
    children: [
      {
        ...
        path: '~/Books/deep_learning.pdf',
        type: 'file',
        size: 41943040,
      },
      { name: 'clean_code.epub', path: '~/Books/clean_code.epub', type: 'file', size: 3145728 },
      {
        name: 'design_patterns.epub',
        path: '~/Books/design_patterns.epub',
        type: 'file',
        size: 2621440,
      },
      {
        name: 'algorithms_introduction.pdf',
        path: '~/Books/algorithms_introduction.pdf',
        type: 'file',
        size: 52428800,
      },
