<template>
  <Dialog :open="open" @update:open="$emit('update:open', $event)">
    <DialogContent class="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
      <DialogHeader>
        <DialogTitle class="text-2xl font-semibold text-foreground mb-2">
        ...
        <div class="space-y-4 mb-8">
          ...
          >
            ...
            <div class="space-y-2 text-sm text-amber-800 dark:text-amber-200">
              ...
              <div class="flex items-start gap-2">
                <span class="text-amber-600 dark:text-amber-400">•</span>
                <span
                  ><strong>Do you want to bring your specialized AI model?</strong> → Choose
          ...
          >
            <div class="flex items-start gap-4">
              <div
                class="w-12 h-12 bg-blue-100 dark:bg-blue-950/50 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-blue-200 dark:group-hover:bg-blue-950 transition-colors"
              >
                <Database class="w-6 h-6 text-blue-600 dark:text-blue-400" />
              </div>
              <div class="flex-1">
                <div class="flex items-center justify-between mb-1">
                  <h3 class="text-lg font-semibold text-foreground">Documents & Data</h3>
                  <div
              ...
              <ChevronRight
                class="w-5 h-5 text-muted-foreground group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors"
              />
            </div>
          </button>
          ...
          >
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-sm text-muted-foreground mb-3">
                  Bring your existing models or quickly set up a local one. A great choice for
                  sharing your model or simply setting up a complete AI workflow on your machine.
                </p>
                <div class="mb-3">
                  <p class="text-xs text-muted-foreground mb-2">Popular for:</p>
                  <div class="flex flex-wrap gap-2">
        ...
        <div class="bg-muted border border-border rounded-lg p-4">
          <div class="flex items-start gap-3">
            ...
            <div class="text-sm text-muted-foreground">
              ...
              <p>
                All content remains on your infrastructure. You maintain complete control over
                access permissions and can review every request before approval.
              </p>
            </div>
          </div>
        </div>
